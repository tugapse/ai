class Color:
    ...
    # Note: BRIGHT_RED, BRIGHT_GREEN, etc. are redundant with user's RED, GREEN, etc.
    # but BRIGHT_CYAN and BRIGHT_WHITE are new.
...
# Note: pformat_text is generally not needed if func.out and func.log handle printing directly.
# Keeping it here for completeness based on your provided class, but consider if it's still used.
