Identify the current Git branch name for the version designation. Perform a granular analysis of the Git delta between this branch and 'master' by examining both 'git log --pretty=format:"%s - %b"' and 'git diff --stat'.
